...
const HALF_EXTENTS: Record<SceneObjectType, Vec3> = {
  ...
  barrier: [0.6, 0.55, 0.5],
  foh_tower: [1.5, 1.3, 1.5],
  tree: [1.3, 2.3, 1.3],
  bush: [0.8, 0.5, 0.8],
  bar_stand: [1.7, 1.3, 1.25],
  food_stand: [1.3, 1.25, 1.0],
  tent: [1.2, 1.25, 1.2],
  portaloo: [0.55, 1.15, 0.55],
  flag_pole: [0.7, 2.5, 0.15],
  fence_panel: [1.1, 1.0, 0.06],
