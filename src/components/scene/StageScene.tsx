...
import { evaluateEvents, withGroupTargets } from '../../utils/events';
...
export function StageScene() {
  ...
  useFrame((_, delta) => {
    ...
    const merged = liveEvents.length ? [...events, ...liveEvents] : events;
    const all = withGroupTargets(merged, groups ?? []);
